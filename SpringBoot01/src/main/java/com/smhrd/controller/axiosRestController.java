...
@RestController //데이터를 응답하는 컨트롤러에 RestController 어노테이션을 붙임
//>> @ResponseBody를 붙이지 않아도 된다. 붙여도 상관x
public class axiosRestController {
	...
	public List<Board> axios03(@RequestBody String data) {
		...
		// 수집할 병수 앞에 @RequestBody 어노테이션을 붙인다. 
		...
		//jackson databind : 자바 객체 리턴 시 json으로 변환이 일어남
